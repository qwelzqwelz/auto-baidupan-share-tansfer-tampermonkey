...
!(function() {
    ...
    var bad_md5 = [
        "fcadf26fc508b8039bee8f0901d9c58e",
        "2d9a55b7d5fe70e74ce8c3b2be8f8e43",
    ...
    var html_check_md5 = "<p "
        ...
        .concat(myBtnStyle, '><span class="g-button-right" ')
        .concat(myBtnStyle, '><span class="text" style="width: auto;">\u6D4B\u8BD5</span></span></a></p>');
    var html_document = "<p "
        .concat(
            myStyle,
            '>\u751F\u6210\u8FC7\u7A0B\u4E2D\u9047\u5230\u95EE\u9898\u53EF\u53C2\u8003<a class="g-button g-button-blue" '
        )
        .concat(
            myBtnStyle,
    ...
    var html_donate = '<p id="bdcode_donate" '
        ...
        .concat(myBtnStyle, '><span class="g-button-right" ')
        .concat(myBtnStyle, '><span class="text" style="width: auto;">\u4E0D\u518D\u663E\u793A</span></span></a></p>');
        ...
        file_info_list.forEach(function(item) {
            if (item.hasOwnProperty("errno")) {
                ...
                failed_info += "<p>\u6587\u4EF6\uFF1A"
                    ...
                    .concat(checkErrno(item.errno, item.size), "(#")
                    .concat(item.errno, ")</p>");
            }
        });
        Swal.fire({
    ...
    function initButtonGen() {
        ...
        if (listTools && listTools.$box) {
            $(listTools.$box)
                .children("div")
                .after(html_btn_gen + html_fix_dl);
            initButtonEvent();
        } else {
    ...
    function try_get_md5(file_id, file_date) {
        ...
        var get_dl_par = {
            ...
            onload: function onload(r) {
                var file_md5 =
                    r.responseText.match(/"block_list":\["([\da-f]{32})"\]/i) ||
                    r.responseText.match(/md5":"([\da-f]{32})"/i);
