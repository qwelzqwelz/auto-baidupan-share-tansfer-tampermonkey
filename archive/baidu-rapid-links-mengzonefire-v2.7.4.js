...
/******/ (() => {
    ...
    (() => {
        ...
        var htmlDocument =
            ...
            '" ' +
            btnStyle +
            '><span class="text" style="width: auto;">\u8F7D\u70B91</span></a><a href="' +
            doc2.shareDoc +
            '" ' +
            btnStyle +
            '><span class="text" style="width: auto;">\u8F7D\u70B92</span></a></p>';
        var htmlDonate =
            '<p id="mzf_donate" class="mzf_text">\u82E5\u559C\u6B22\u8BE5\u811A\u672C, \u53EF\u524D\u5F80 <a href="' +
            donatePage +
            '" ' +
            linkStyle +
        ...
        DuParser.parseDu_v4 = function parseDu_v3(szUrl) {
            return szUrl
                .split("\n")
                .map(function (z) {
                    return z.trim().match(/^([\da-f]{9}[\da-z][\da-f]{22})#(?:([\da-f]{32})#)?([\d]{1,20})#([\s\S]+)/i); // 22.8.29新增支持第10位为g-z的加密md5, 输入后自动解密转存
                })
                .filter(function (z) {
                    return z;
                })
        ...
        var sweetalert2_all_default = /*#__PURE__*/ __webpack_require__.n(sweetalert2_all); // CONCATENATED MODULE: ./src/common/swalBase.tsx
        /*
         * @Author: mengzonefire
        ...
        var Swalbase = /** @class */ (function () {
                            ...
                            case 2:
                                ...
                                preConfirm = function () {
                                    ...
                                    if (!DuParser.parse(inputValue).length) {
                                        sweetalert2_all_default().showValidationMessage(
                                            '<p>\u672A\u8BC6\u522B\u5230\u6B63\u786E\u7684\u94FE\u63A5 <a href="' +
                                                doc.linkTypeDoc +
                                                '" ' +
                                                linkStyle +
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    // 设置极速生成, 若开启则弹出文本提醒
                                    if ($("#mzf-fast-generate")[0].checked) showAlert(appWarning.fastGenerateWarn);
            ...
            Swalbase.prototype.saveFileWork = function () {
                ...
                this.rapiduploadTask.onProcess = function (i, fileInfoList) {
                    sweetalert2_all_default().getHtmlContainer().querySelector("file_num").textContent =
        ...
        var GeneratebdlinkTask = /** @class */ (function () {
            ...
            GeneratebdlinkTask.prototype.downloadFileData = function (i, dlink) {
                ...
                var dlSize,
                    file = this.fileInfoList[i];
                if (this.isFast) dlSize = 1; // "极速下载" 不需要生成slice-md5, 故无需下载文件数据
                ...
                ajax(
                    ...
                    function (data) {
                        if (!_this.isFast) _this.onProgress({ loaded: 100, total: 100 }); // 100%
     ...
     * 追加部分代码说明:
     * 1. 依赖于 jQuery
     * 2. 不依赖于 `mengzonefire/rapid-upload-userscript` 项目的脚本，可以独立运行
     */
